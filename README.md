...
本仓库提供面向 IAM Core v1.9.0（兼容既有 v1.8.1 Runtime/Management 契约）的 Go SDK。`v0.9.1` 使用单一 Go Module
...
`v0.9.1` 保持 Gin 和 Redis Adapter 合并进根 Module，公开 import 路径不变，并新增单用途
...
```bash
go get github.com/swan-swan-swan/iam-core-sdk-go@v0.9.1
```
