...
本仓库提供面向 IAM Core v1.8.1 的 Go SDK。`v0.4.1` 使用单一 Go Module
...
`v0.4.1` 保持 Gin 和 Redis Adapter 合并进根 Module，公开 import 路径不变。升级前请阅读
...
```bash
go get github.com/swan-swan-swan/iam-core-sdk-go@v0.4.1
```
